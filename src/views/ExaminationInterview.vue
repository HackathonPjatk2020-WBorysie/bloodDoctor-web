    ...
    <mdb-card-body>
        <form @submit.prevent="initiateForm()">
            ...
            <mdb-list-group class="mb-3">
                ...
                <mdb-list-group-item>
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="morfology" value="morfology"
                               v-model="tests">
                ...
                <mdb-list-group-item>
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="biochemy" value="biochemy"
                               v-model="tests">
                ...
                <mdb-list-group-item>
                    <div class="custom-control custom-checkbox">
                        <input type="checkbox" class="custom-control-input" id="immunology" value="immunology"
                               v-model="tests">
            ...
            <div class="d-flex justify-content-between w-100">
                <mdb-btn outline="primary" @click="goToHome()">Wstecz</mdb-btn>
                <mdb-btn type="submit" color="primary">Dalej</mdb-btn>
            </div>
